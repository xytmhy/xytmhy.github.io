...
J Zhang, Q Liao, S Liu, H Ma, W Yang, J. -H. Xue, " **Real-MFF: A large realistic multi-focus image dataset with ground truth** ,", Pattern Recognition Letters, vol. 138, pp. 370-377, 2020, doi: 10.1016/j.patrec.2020.08.002.
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/xytmhy/xytmhy.github.io/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
